...
exports.FailedToDetectJsonFileError = exports.InvalidYamlFileError = exports.InvalidJsonFileError = exports.UnsupportedFileTypeError = exports.tryParseIacFile = exports.parseFiles = void 0;
...
function tryParseIacFile(fileData, options = {}) {
    ...
    switch (fileData.fileType) {
        ...
        case 'yml': {
            ...
            return kubernetes_parser_1.tryParsingKubernetesFile(fileData, parsedIacFile);
        }
        case 'json': {
            const parsedIacFile = parseYAMLOrJSONFileData(fileData);
            ...
            if (parsedIacFile.length === 1 && terraform_plan_parser_1.isTerraformPlan(parsedIacFile[0])) {
                ...
                try {
                    ...
                    if (e instanceof kubernetes_parser_1.MissingRequiredFieldsInKubernetesYamlError) {
...
class FailedToDetectJsonFileError extends errors_1.CustomError {
    constructor(filename) {
        super('Failed to detect either a Kubernetes file or Terraform Plan, missing required fields');
        this.code = types_1.IaCErrorCodes.FailedToDetectJsonFileError;
        this.strCode = error_utils_1.getErrorStringCode(this.code);
        this.userMessage = `We were unable to detect whether the JSON file "${filename}" is a valid Kubernetes file or Terraform Plan. For Kubernetes it is missing the following fields: "${kubernetes_parser_1.REQUIRED_K8S_FIELDS.join('", "')}". For Terraform Plan it was expected to contain fields "planned_values.root_module" and "resource_changes". Please contact support@snyk.io, if possible with a redacted version of the file`;
    }
}
exports.FailedToDetectJsonFileError = FailedToDetectJsonFileError;
